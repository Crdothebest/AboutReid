...
from modeling.clip.idea_text_encoder import create_idea_text_encoder
from modeling.backbones.vit_pytorch import Mlp


"""
IDEA项目的meta_arch实现
完全复制IDEA项目中的文本编码和处理逻辑
"""
...
class build_transformer(nn.Module):
    ...
    def forward(self, image, text=None, label=None, cam_label=None, view_label=None, modality=None):
        ...
        if text is not None:
            # 使用IDEA风格的文本编码器
            text_features = self.text_encoder(text, modality)
